...
//        DataUtils.playSound(getApplicationContext(),R.raw.click);
        Uri uri;
        Intent intent;
//        uri = Uri.parse("http://www.amazon.com/gp/mas/dl/android?p=com.superapp.notnhacvuivangbolerotrochoiamnhac");
//        uri=Uri.parse("http://appvn.com/android/details?id=com.superapp.notnhacvuivangbolerotrochoiamnhac");
//        uri = Uri.parse("http://play.google.com/store/apps/details?id=com.superapp.notnhacvuivangboleo");
